...
fun PrintWriter.solve() {
    ...
    val answer = mergeSort(array).joinToString(" ")
    println(answer)
}
...
fun mergeSort(nums: IntArray): IntArray {
    ...
    var left = mergeSort(nums.copyOfRange(0, middle))
    var right = mergeSort(nums.copyOfRange(middle, nums.size))

    return merge(left, right, nums)
}

fun merge(left: IntArray, right: IntArray, result: IntArray): IntArray {
    var l = 0
    var r = 0
