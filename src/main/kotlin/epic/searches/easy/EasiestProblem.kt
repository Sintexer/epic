...
fun PrintWriter.solve() {
    ...
    println(easiestSolution(n, x.toDouble(), y.toDouble()))
}

fun easiestSolution(n: Int, x: Int, y: Int) = easiestSolution(n, x.toDouble(), y.toDouble())
